...
class Our_TV extends StatefulWidget {
  const Our_TV({Key? key}) : super(key: key);

  @override
  _Our_TVState createState() => _Our_TVState();
}

class _Our_TVState extends State<Our_TV> {
  ...
  Future<void> fetchNewNews({bool refresh = false}) async {
    if (!isLoading && mounted) {
      ...
      try {
        ...
        final response = await fetchNews(2, currentPage);
